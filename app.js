...
function autoMoveElements() {
  ...
  logsLeft.forEach((carLeft) => moveLogLeft(carLeft));
...
function moveLogLeft(carLeft) {
  switch (true) {
    ...
    case carLeft.classList.contains("l3"):
      ...
      carLeft.classList.add("l4");
      break;
    case carLeft.classList.contains("l4"):
      carLeft.classList.remove("l4");
      carLeft.classList.add("l5");
      break;
    case carLeft.classList.contains("l5"):
      carLeft.classList.remove("l5");
